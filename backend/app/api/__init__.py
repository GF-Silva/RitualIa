...
from .routes.copa import get_team_data_by_name, brazilian_music
...
api_router.include_router(get_team_data_by_name.router)
api_router.include_router(brazilian_music.router)